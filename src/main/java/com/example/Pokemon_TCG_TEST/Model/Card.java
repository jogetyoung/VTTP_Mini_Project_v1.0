...
public class Card {
    ...
    public SetDetails getSet() {
        return set;
    }

    public void setSet(SetDetails set) {
        this.set = set;
    }
    ...
    public static class Prices {
        ...
        public Double getMid() {
            return mid != null ? mid : 0.0; // Default to 0.0 if price is null
        }
        ...
        public Double getHigh() {
            return high != null ? high : 0.0; // Default to 0.0 if price is null
        }
        ...
        public Double getMarket() {
            return market != null ? market : 0.0; // Default to 0.0 if price null
        }
